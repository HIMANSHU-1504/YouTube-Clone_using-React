  ...
  return (
    <Box sx={{boxShadow: 'none',borderRadius:'20px',display:'flex',justifycontent: 'center',alignItems: 'center', width:{xs:'356px', md:'320px'},height:'326px',margin:'auto',marginTop ,}}>
        <Link to={`/channel/${channelDetail?.id?.channelId}`}>
            <cardContent sx={{ display: 'flex', flexdirection:'column', justifycontent:'centre', textAlign:'centre', color: '#fff'}}>
                <CardMedia
                ...
                <Typography>{parseInt(channelDetail?.statistics?.subscriberCount).toLocaleString()} Subscribers
